...
data class FilterGroup(
    ...
    /**
     * این گروه تویِ شیتِ انتخابِ گروهی که از دکمه‌ی «افزودن به گروه»ِ روی نوتیفیکیشن
     * باز میشه هم نشون داده بشه یا نه. پیش‌فرض true (سازگار با گروه‌های قبلی). این
     * فقط رویِ شیتِ نوتیف اثر داره - شیتِ انتخابِ گروه از سویپ/منویِ داخلِ لیستِ مکالمات
     * (که خودِ کاربر مستقیم داخلِ اپ صداش می‌زنه) همیشه همه‌ی گروه‌ها رو نشون میده.
     */
    val showInNotificationPicker: Boolean = true,
    /**
     * این گروه، مقصدِ دکمه‌ی «افزودن سریع به گروه»ِ روی نوتیفه - بدونِ بازشدنِ اپ یا
     * نمایشِ هیچ شیتی، فرستنده‌ی همون پیام مستقیم به این گروه اضافه میشه. همیشه
     * حداکثر یه گروه می‌تونه این مقدار true باشه.
     */
